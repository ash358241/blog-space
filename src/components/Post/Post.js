...
const Post = ({blogData}) => {
    ...
    return (
        <div>
            <Card className="card" onClick={() => handleClick(_id)} style={{ width: '400px',height: '400px', margin: '0 auto', textAlign: 'center', backgroundColor: '#E2D9CD', border: 'none', cursor: 'pointer' }}>
